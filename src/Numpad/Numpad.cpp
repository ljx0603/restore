...
bool Numpad::nativeEvent(const QByteArray& eventType, void* message, long* result)// winEvent(MSG* p_msg, long* p_result)
{
  ...
  return QWidget::nativeEvent(eventType, message, result); //winEvent(p_msg, p_result);
}	
